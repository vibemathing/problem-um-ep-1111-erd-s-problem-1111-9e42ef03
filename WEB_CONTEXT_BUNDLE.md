...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-1111-erd-s-problem-1111-9e42ef03-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-1111"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-1111-erd-s-problem-1111-9e42ef03-v1",
      "problem_contract_sha256": "6fe3340c7c6dc8bf63b34c771185b7a5d968fd39a3c7983ad15c1c4cb470f65e",
      "problem_id": "problem:um-ep-1111-erd-s-problem-1111-9e42ef03",
      "route_id": "route:um-ep-1111-erd-s-problem-1111-9e42ef03-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-1111-erd-s-problem-1111-9e42ef03-source-fidelity-01",
      "graph_id": "graph:um-ep-1111-erd-s-problem-1111-9e42ef03-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-1111-erd-s-problem-1111-9e42ef03-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-1111-erd-s-problem-1111-9e42ef03-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "If $G$ is a finite graph and $A,B$ are disjoint sets of vertices then we call $A,B$ anticomplete if there are no edges between $A$ and $B$. If $t,c\\geq 1$ then there exists $d\\geq 1$ such that if $\\chi(G)\\geq d$ and $\\omega(G)<t$ then there are anticomplete sets $A,B$ with $\\chi(A)\\geq \\chi(B)\\geq c$."
          },
          "statement_sha256": "96204d07984ade1a54d94aca4cd4a9f5be091e94ca9162416764ec247c131e8f"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-1111-erd-s-problem-1111-9e42ef03-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-1111-erd-s-problem-1111-9e42ef03-root",
      "route_id": "route:um-ep-1111-erd-s-problem-1111-9e42ef03-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-1111-089ba4abf90c",
        "url": "https://www.unsolvedmath.com/problems/EP-1111"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
